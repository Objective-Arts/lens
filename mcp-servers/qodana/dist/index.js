    ...
    try {
        switch (name) {
            ...
            case 'qodana_results': {
                ...
                const resultsDir = args.resultsDir || `${projectDir}/.qodana`;
            ...
            case 'qodana_problems': {
                ...
                if (file) {
                    problems = problems.filter(p => p.sources.some(s => s.file.includes(file)));
                }
                if (category) {
            ...
            case 'qodana_baseline': {
                const projectDir = args.projectDir;
                const baselinePath = args.baselinePath || `${projectDir}/qodana.baseline.json`;
                const resultsDir = `${projectDir}/.qodana`;

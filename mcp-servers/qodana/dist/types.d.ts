...
export type QodanaLinter = 'qodana-jvm-community' | 'qodana-jvm' | 'qodana-jvm-android' | 'qodana-php' | 'qodana-python-community' | 'qodana-python' | 'qodana-js' | 'qodana-dotnet' | 'qodana-go' | 'qodana-rust' | 'qodana-cpp' | 'qodana-ruby';

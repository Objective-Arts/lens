---
name: ralph-loop
description: Autonomous PRD implementation with 11-phase quality pipeline. Keeps going until done.
---

# /ralph-loop [prd-file] [--max N] [--resume]

Autonomous loop that implements PRD items through a 11-phase quality pipeline.
...
Ralph exists to produce code that looks like it was written by a skilled human engineer, not generated by AI. This is the north star for all 11 phases.

...
| 11 | **write-tests-run** | — | test-doubles, test-strategy | Write and run tests (final inspection — ALWAYS LAST) |
| 11.5 | *machine gate* | — | — | `npm test` + quality-gate (final) |

Machine gates run between phases 3-4, 7-8, 10-11, and after 11.
...
- `createPhases()` - Create the 11 phase instances

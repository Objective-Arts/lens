...
description: Security-first thinking for authentication, authorization, data handling, APIs, and cryptography. Triggers on auth, login, password, token, session, permission, encryption, secrets, API keys, user input validation, SQL queries, or when touching sensitive data.
---

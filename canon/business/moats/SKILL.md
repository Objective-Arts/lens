...
1. **Affective valence** - evokes positive emotion
2. **Uncertainty reduction** - trusted to deliver quality
3. **Built over time** - not manufacturable quickly
...
1. **Which Powers does this business have?** Be specific.
2. **What's the Benefit?** How does it create superior returns?
3. **What's the Barrier?** Why can't competitors copy it?
4. **Is the Barrier real?** Or wishful thinking?
5. **What stage is the business?** Origination, takeoff, stability?
6. **What Powers should they build next?** Before current Powers fade?

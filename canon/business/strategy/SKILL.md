...
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│   1. DIAGNOSIS        What's really going on? What's the        │
│                       challenge we face?                        │
│                                                                 │
│         │                                                       │
│         ▼                                                       │
│                                                                 │
│   2. GUIDING POLICY   What's our approach? What trade-offs     │
│                       define our direction?                     │
│                                                                 │
│         │                                                       │
│         ▼                                                       │
│                                                                 │
│   3. COHERENT ACTION  What specific steps? How do they         │
...
**Example:**
"Our strategy is to be a customer-centric organization that leverages synergies across our portfolio to deliver innovative solutions that maximize shareholder value."
...
**Example:**
"Our strategy is to grow revenue by 20% per year."
...
**Example:**
"Our strategy is to be #1 in our market."
...
**Example:**
"Our priorities are: quality, innovation, customer satisfaction, employee engagement, sustainability, market leadership, and operational excellence."
...
**Too proximate:** "Answer customer calls within 3 rings"
**Too distant:** "Become the global leader"
**Just right:** "Within 18 months, be the clear #1 choice in the SMB segment in North America"
...
1. **Is there a diagnosis?** Does it name the real challenge? Or is it vague?
2. **Is there a guiding policy?** Does it make trade-offs? Or is it "be excellent"?
3. **Are actions coherent?** Do they reinforce each other? Or is it a to-do list?
4. **Is it fluff?** Buzzwords without meaning?
5. **Is it just goals?** "Be #1" is not strategy.
6. **Does it face the challenge?** Or avoid naming what's hard?
7. **Are objectives proximate?** Achievable yet meaningful?
8. **Is focus present?** Or trying to do everything?
